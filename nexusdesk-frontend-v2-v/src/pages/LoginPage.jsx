  ...
  return (
    <div style={{ width: '100%', maxWidth: '420px' }}>
      ...
      <div style={{ background: 'var(--color-surface)', borderRadius: '18px', padding: '36px', boxShadow: 'var(--shadow-lg)', border: '1px solid var(--color-border)' }}>
        ...
        {tab === 'register' && (
          <><label style={lbl}>Full Name</label><input style={inp} placeholder="Your full name" value={form.name} onChange={e => set('name', e.target.value)} /></>
        )}
  ...
  return (
    <div style={{ width: '100%', maxWidth: '420px' }}>
      ...
      <div style={{ background: 'var(--color-surface)', borderRadius: '18px', padding: '36px', boxShadow: 'var(--shadow-lg)', border: '1px solid var(--color-border)' }}>
        ...
        {error && <div style={errBox}>{error}</div>}
        {tab === 'register' && (
          <><label style={lbl}>Full Name</label><input style={inp} placeholder="Your name" value={form.name} onChange={e => set('name', e.target.value)} /></>
        )}
        <label style={lbl}>Email</label>
